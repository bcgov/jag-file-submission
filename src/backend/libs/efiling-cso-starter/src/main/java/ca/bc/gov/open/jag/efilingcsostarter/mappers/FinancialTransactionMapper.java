...
public interface FinancialTransactionMapper {
    ...
    @Mapping(target = "transactionTypeCd", source = "efilingTransaction.transactionTypeCd")
    @Mapping(target = "transactionSubtypeCd", source = "efilingTransaction.transactionSubtypeCd")
    @Mapping(target = "creditCardTypeCd", source = "efilingTransaction.creditCardTypeCd")
    @Mapping(target = "processDt", source = "efilingTransaction.processDt")

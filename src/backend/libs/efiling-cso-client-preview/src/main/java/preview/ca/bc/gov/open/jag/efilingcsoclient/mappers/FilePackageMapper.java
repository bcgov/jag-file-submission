...
import preview.ca.bc.gov.ag.csows.filing.status.File;
import preview.ca.bc.gov.ag.csows.filing.status.PackageParties;
...
public interface FilePackageMapper {
    ...
    ReviewFilingPackage toFilingPackage(preview.ca.bc.gov.ag.csows.filing.status.FilePackage filePackage, String csoHistoryLink, List<Individual> individuals, List<Organization> organizations);

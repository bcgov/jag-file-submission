...
public class FilingPackageServiceImplTest {
    ...
    public void withValidRequestReturnFilingPackage() {
        ...
        Assertions.assertEquals("2020-05-05T00:00:00.000-07:00", result.get().getSubmittedDate());
        ...
        Assertions.assertEquals("2020-05-05T00:00:00.000-07:00", result.get().getDocuments().get(0).getStatus().getChangeDate());
        //Payments
        ...
        Assertions.assertEquals("2020-05-05T00:00:00.000-07:00", result.get().getPayments().get(0).getTransactionDate());

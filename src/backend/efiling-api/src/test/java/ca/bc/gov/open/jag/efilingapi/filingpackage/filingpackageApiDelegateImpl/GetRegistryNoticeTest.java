...
public class GetRegistryNoticeTest {
    ...
    @Test
    @DisplayName("200: ok registry notice returned")
    public void withValidRequestReturnRegistryNotice() {
    ...
    public void withNoUniversalIdShouldReturn403() {
        ...
        ResponseEntity<?> actual = sut.getRegistryNotice(BigDecimal.ONE);
